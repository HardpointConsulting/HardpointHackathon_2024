...
# Import other necessary libraries for your NLP code
import pandas as pd
import nltk
...
# Your NLP code function
def process_url(url):
    # Your NLP code to process the URL and generate output
    # For example, you can put your entire NLP code here
    # Replace this example with your actual NLP code
    # output = "Placeholder output for URL: " + url
...
# ************************************************************************************************************
    ...
    "the developer of {adjective} should solve {content}."
    )
    ...
    solution=[]
    for problem in limited_problems:
        filled_prompt = prompt_template.format(adjective=product_category, content=problem)
...
def process():
    ...
    # Call the NLP function to process the URL
    output = process_url(url)
    with open('C:\\Users\\haran\\hack2404notfound\\solution.txt.txt', 'r',  encoding='utf-8') as file:
        text_contents = file.read()
    with open('C:\\Users\\haran\\hack2404notfound\\review_count.png', 'rb') as f1:
        image_data1 = base64.b64encode(f1.read()).decode('utf-8')
    with open('C:\\Users\\haran\\hack2404notfound\\trent_analysis_plot.png', 'rb') as f1:
        image_data2 = base64.b64encode(f1.read()).decode('utf-8')

    return render_template('results.html', output=text_contents, img1=image_data1, img2=image_data2)
